    ...
    return (
        <>
            <div className=" relative z-20 max-w-[90%] grid grid-cols-2 mx-auto p-4 rounded-[1rem] shadow-lg shadow-gray-400 overflow-hidden text-white">
                ...
                <div>
                    <img className="w-full h-full absolute z-0 top-0 left-0 opacity-30 brightness-75 object-cover object-center" id="weather_bg" src="./src/assets/weather_bg/wbg_clouds.avif" alt="" />
                </div>
            </div>
